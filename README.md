...
|--------|------|----------|-----|
| **bsv.min.js** | 1149KB | Core BSV + SmartContract | `unpkg.com/@smartledger/bsv@8.1.0/bsv.min.js` |
| **bsv.bundle.js** | 1149KB | Everything in one file | `unpkg.com/@smartledger/bsv@8.1.0/bsv.bundle.js` |

### **W3C Verifiable Credentials**
| Module | Size | Use Case | CDN |
|--------|------|----------|-----|
| **🟢 bsv-didweb.min.js** | 315KB | **DID:web generation** | `unpkg.com/@smartledger/bsv@8.1.0/bsv-didweb.min.js` |
| **🟢 bsv-vcjwt.min.js** | 315KB | **VC-JWT issue/verify** | `unpkg.com/@smartledger/bsv@8.1.0/bsv-vcjwt.min.js` |
| **🟢 bsv-statuslist.min.js** | 415KB | **StatusList2021 revocation** | `unpkg.com/@smartledger/bsv@8.1.0/bsv-statuslist.min.js` |
| **🟢 bsv-anchor.min.js** | 314KB | **BSV anchoring (hash-only)** | `unpkg.com/@smartledger/bsv@8.1.0/bsv-anchor.min.js` |

### **Smart Contract & Development**
| Module | Size | Use Case | CDN |
|--------|------|----------|-----|
| **bsv-smartcontract.min.js** | 873KB | Complete covenant framework | `unpkg.com/@smartledger/bsv@8.1.0/bsv-smartcontract.min.js` |
| **bsv-covenant.min.js** | 873KB | Covenant operations | `unpkg.com/@smartledger/bsv@8.1.0/bsv-covenant.min.js` |
| **bsv-script-helper.min.js** | 30KB | Custom script tools | `unpkg.com/@smartledger/bsv@8.1.0/bsv-script-helper.min.js` |
| **bsv-security.min.js** | 30KB | Security enhancements | `unpkg.com/@smartledger/bsv@8.1.0/bsv-security.min.js` |

### **Legal & Compliance**
| Module | Size | Use Case | CDN |
|--------|------|----------|-----|
| **bsv-ltp.min.js** | 1149KB | Legal Token Protocol | `unpkg.com/@smartledger/bsv@8.1.0/bsv-ltp.min.js` |
| **bsv-gdaf.min.js** | 1149KB | Digital Identity & Attestation | `unpkg.com/@smartledger/bsv@8.1.0/bsv-gdaf.min.js` |

### **Advanced Cryptography**
| Module | Size | Use Case | CDN |
|--------|------|----------|-----|
| **bsv-shamir.min.js** | 353KB | Threshold Cryptography | `unpkg.com/@smartledger/bsv@8.1.0/bsv-shamir.min.js` |

### **Utilities**
| Module | Size | Use Case | CDN |
|--------|------|----------|-----|
| **bsv-ecies.min.js** | 79KB | Encryption | `unpkg.com/@smartledger/bsv@8.1.0/bsv-ecies.min.js` |
| **bsv-message.min.js** | 30KB | Message signing | `unpkg.com/@smartledger/bsv@8.1.0/bsv-message.min.js` |
| **bsv-mnemonic.min.js** | 592KB | HD wallets | `unpkg.com/@smartledger/bsv@8.1.0/bsv-mnemonic.min.js` |
...
```html
<script src="https://unpkg.com/@smartledger/bsv@8.1.0/bsv.min.js"></script>
<script src="https://unpkg.com/@smartledger/bsv@8.1.0/bsv-script-helper.min.js"></script>
<script>
  const privateKey = new bsv.PrivateKey();
...
```html
<script src="https://unpkg.com/@smartledger/bsv@8.1.0/bsv.min.js"></script>
<script src="https://unpkg.com/@smartledger/bsv@8.1.0/bsv-covenant.min.js"></script>
...
```html
<script src="https://unpkg.com/@smartledger/bsv@8.1.0/bsv.min.js"></script>
<script src="https://unpkg.com/@smartledger/bsv@8.1.0/bsv-security.min.js"></script>
<script src="https://unpkg.com/@smartledger/bsv@8.1.0/bsv-shamir.min.js"></script>
<script>
...
canonical `unpkg.com/@smartledger/bsv@8.1.0/...` URLs.
