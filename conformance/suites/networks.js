...
Object.assign(cases, {
  ...
  'get with an unknown argument': (bsv) => bsv.Networks.get('nonesuch') === undefined ? null : bsv.Networks.get('nonesuch'),
  ...
  'alias is absent on every built-in network': (bsv) =>
    ['livenet', 'testnet', 'regtest', 'stn'].map((n) => {
      ...
      return { network: n, alias: net != null && net.alias !== undefined ? net.alias : null }
    })
})
