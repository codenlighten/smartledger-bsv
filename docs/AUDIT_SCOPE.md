...
Measured against **v8.1.0**, 2026-08-13. Re-measure before sending if the version has
...
Totals reconcile against `lib/`, which is 36,690 lines across 123 files:
...
- **4,461 passing tests**, plus a reproducible-bundle gate, a require-cycle gate, and a
...
summing to 37,430 against a 36,690 whole; §7 could not catch it because it reproduced
