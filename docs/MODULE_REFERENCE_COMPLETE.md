...
- **CDN**: `unpkg.com/@smartledger/bsv@5.0.0/bsv-shamir.min.js`
...
- **CDN**: `unpkg.com/@smartledger/bsv@5.0.0/bsv-gdaf.min.js`
...
- **CDN**: `unpkg.com/@smartledger/bsv@5.0.0/bsv-ltp.min.js`
...
| **bsv-smartcontract.min.js** | 937KB | Covenant development | `unpkg.com/@smartledger/bsv@5.0.0/bsv-smartcontract.min.js` |
...
| **bsv-security.min.js** | 26KB | Security enhancements (opt-in helpers — see README › Security) | `unpkg.com/@smartledger/bsv@5.0.0/bsv-security.min.js` |
...
| **🆕 bsv-shamir.min.js** | 432KB | **Secret sharing** | `unpkg.com/@smartledger/bsv@5.0.0/bsv-shamir.min.js` |
| **🆕 bsv-gdaf.min.js** | 1184KB | **Digital attestation** | `unpkg.com/@smartledger/bsv@5.0.0/bsv-gdaf.min.js` |
| **🆕 bsv-ltp.min.js** | 1184KB | **Legal tokens** | `unpkg.com/@smartledger/bsv@5.0.0/bsv-ltp.min.js` |
