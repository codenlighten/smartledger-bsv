...
class CovenantInterface {
  constructor () {
    // Full access to the underlying BSV library. Required here rather than at
    // module scope: this file is reached while index.js is still initializing,
    // so a top-level require of the root would capture a half-built namespace.
    // Constructor time is after load, so the require is safe and complete.
    this.bsv = require('../index.js'); // eslint-disable-line
  }
