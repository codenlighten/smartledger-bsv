...
var LTPProof = {
  ...
  prepareSignatureVerification: function(token, publicKey) {
    try {
      ...
      // ECDSA.prototype.verify() returns the instance (always truthy) and stashes
      // the real result on .verified — read the boolean, never the instance.
      var isValid = ecdsa.verify().verified === true
