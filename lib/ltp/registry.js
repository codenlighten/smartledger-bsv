...
var LTPRegistry = {
  ...
  _generateAuditId: function() {
    // 128 bits. Audit entries are minted per action and retained for years, and
    // a collision silently overwrites a record in a Map-keyed store, so this is
    // sized to close the birthday question outright rather than to match the
    // per-registry ids above (which are minted once each).
    return 'audit_' + Id.randomHex(32)
  },
