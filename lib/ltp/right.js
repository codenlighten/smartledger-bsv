...
function _resolveIssuerPublicKey (token, options) {
  ...
  if (options.issuerPublicKey) {
    return options.issuerPublicKey instanceof PublicKey
      ? options.issuerPublicKey
      : PublicKey.fromString(options.issuerPublicKey)
  }
  ...
  try {
    ...
    return PublicKey.fromString(identifier)
  } catch (e) {
    return null
  }
}
...
var RightToken = {
  ...
  verifyToken: function(token, publicKey) {
    ...
    try {
      ...
      var pubKey = publicKey instanceof PublicKey
        ? publicKey
