 ...
 * (520 / 4 / 201) remain the out-of-the-box behavior; call this before verify()
 * to run modern covenants such as OP_PUSH_TX. Pass a custom ceiling to bound it.
 * @param {number} [max=0x7fffffff]
