  ...
  if (fExec && opcodenum >= 0 && opcodenum <= Opcode.OP_PUSHDATA4) {
    ...
    switch (opcodenum) {
      ...
      case Opcode.OP_RSHIFTNUM:
        ...
        var maxNumSize = Interpreter.MAXIMUM_ELEMENT_SIZE
      ...
      case Opcode.OP_SUBSTR:
        ...
        buf1 = stacktop(-3)
        var subSize = BN.fromScriptNumBuffer(stacktop(-1), fRequireMinimal, Interpreter.MAXIMUM_ELEMENT_SIZE).toNumber()
        var subBegin = BN.fromScriptNumBuffer(stacktop(-2), fRequireMinimal, Interpreter.MAXIMUM_ELEMENT_SIZE).toNumber()
