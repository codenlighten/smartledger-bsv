...
const opcodeMap = {
  ...
  // Chronicle reassigned 0xb3-0xb7, so OP_NOP4..OP_NOP8 no longer exist. The two
  // survivors keep their own numbers; 0xb6/0xb7 are the shift opcodes and are rejected
  // rather than treated as no-ops (see lib/opcode.js).
  OP_NOP9:         {
    code: 0xb8,
    category: 'nop',
    description: 'No operation (reserved for future use)',
