...
// Named Sighash, not sighash: this file already uses `sighash` as a local
// variable for a SIGHASH instance further down, and a module-scope binding of
// the same name would be shadowed inside that function.
...
function SIGHASH(sighashType) {
  ...
  this.sighashType = sighashType || (Signature.SIGHASH_ALL | Signature.SIGHASH_FORKID)
...
SIGHASH.getAllTypes = function() {
  ...
  return [
    { name: 'ALL', value: Signature.SIGHASH_ALL | forkId },
    { name: 'NONE', value: Signature.SIGHASH_NONE | forkId },
    { name: 'SINGLE', value: Signature.SIGHASH_SINGLE | forkId },
    { name: 'ALL | ANYONECANPAY', value: Signature.SIGHASH_ALL | Signature.SIGHASH_ANYONECANPAY | forkId },
    { name: 'NONE | ANYONECANPAY', value: Signature.SIGHASH_NONE | Signature.SIGHASH_ANYONECANPAY | forkId },
    { name: 'SINGLE | ANYONECANPAY', value: Signature.SIGHASH_SINGLE | Signature.SIGHASH_ANYONECANPAY | forkId }
  ]
}
