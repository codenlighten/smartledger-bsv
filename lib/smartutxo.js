...
// Library primitives, required directly rather than through the package root.
// createMockUTXOs() previously did a lazy `require('../')` to dodge the
// module-init cycle; with the cycle gone these can be plain top-level imports.
...
class SmartUTXOManager {
  ...
  createMockUTXOs (address, count = 5, satoshis = 100000) {
    ...
    const lockingScriptHex = Script.buildPublicKeyHashOut(
